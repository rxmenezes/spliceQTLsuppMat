...
Now put together the matrix with effects `B`, here denoted by object `Bl` to refer to the larger number of exons (50). In the code chunk below SNP effects are generated. To reproduce the published figures exactly, we load in the subsequent code chunk the original objects.
