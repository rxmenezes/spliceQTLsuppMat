...
# rho <- mu <- c(-1,-0.5,0,0.5,1) # Different values for rho and mu can be tested
...
save(v.results, file=paste0(mydir.output,"/spliceQTL_fit_VariousNperm_.RData")) # v.results, chr 1 only, no 1-exon genes
